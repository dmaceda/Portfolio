...
export const data = [
  ...
  },
  {
    ...
    title: "PokeDex",
    description:
      "Esta aplicación consume la API pokemon.io y nos muestra un listado de todos los Pokemons disponibles, permite filtrarlos y contiene paginado. También se podrá ver el detalle de cada Pokemon con mas información relevante. Se utilizó Material Angular y SCSS para estilos.",
